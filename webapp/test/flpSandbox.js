		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WM Tüketim Hareketleri",
									"targetURL": "#combtczwmtuketimhareketleri-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combtczwmtuketimhareketleri-display": {
								"semanticObject": "combtczwmtuketimhareketleri",
								"action": "display",
								"description": "WM Tüketim Hareketleri",
								"title": "WM Tüketim Hareketleri",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.btc.zwmtuketimhareketleri",
									"url": sap.ui.require.toUrl("com/btc/zwmtuketimhareketleri")
								}
							}
						}
					}
